...
<!--PATTERN SingleFormalTitlePerTerritory-->
	...
	<!--RULE -->
<xsl:template match="ernm:NewReleaseMessage/ReleaseList/Release/ReleaseDetailsByTerritory" priority="1000" mode="M15"><svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="ernm:NewReleaseMessage/ReleaseList/Release/ReleaseDetailsByTerritory"/>
...
<!--PATTERN PrimaryResourcesIdentifiedByISRC-->
	...
	<!--RULE -->
<xsl:template match="//ResourceGroupContentItem/ReleaseResourceReference[@ReleaseResourceType = 'PrimaryResource']" priority="1000" mode="M23"><svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="//ResourceGroupContentItem/ReleaseResourceReference[@ReleaseResourceType = 'PrimaryResource']"/>
