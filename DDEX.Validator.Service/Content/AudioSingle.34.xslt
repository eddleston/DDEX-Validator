...
<!--SCHEMA SETUP-->
<xsl:template match="/"><svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="Audio Single" schemaVersion=""><xsl:comment><xsl:value-of select="$archiveDirParameter"/>   
		 <xsl:value-of select="$archiveNameParameter"/>  
		 <xsl:value-of select="$fileNameParameter"/>  
		 <xsl:value-of select="$fileDirParameter"/></xsl:comment><svrl:ns-prefix-in-attribute-values uri="http://ddex.net/xml/ern/34" prefix="ernm"/><svrl:active-pattern><xsl:attribute name="document"><xsl:value-of select="document-uri(/)"/></xsl:attribute><xsl:attribute name="id">MustContainOneSoundRecording</xsl:attribute><xsl:attribute name="name">MustContainOneSoundRecording</xsl:attribute><xsl:apply-templates/></svrl:active-pattern><xsl:apply-templates select="/" mode="M2"/><svrl:active-pattern><xsl:attribute name="document"><xsl:value-of select="document-uri(/)"/></xsl:attribute><xsl:attribute name="id">MustContainMusicalWorkSoundRecording</xsl:attribute><xsl:attribute name="name">MustContainMusicalWorkSoundRecording</xsl:attribute><xsl:apply-templates/></svrl:active-pattern><xsl:apply-templates select="/" mode="M3"/><svrl:active-pattern><xsl:attribute name="document"><xsl:value-of select="document-uri(/)"/></xsl:attribute><xsl:attribute name="id">MustContainOneImage</xsl:attribute><xsl:attribute name="name">MustContainOneImage</xsl:attribute><xsl:apply-templates/></svrl:active-pattern><xsl:apply-templates select="/" mode="M4"/><svrl:active-pattern><xsl:attribute name="document"><xsl:value-of select="document-uri(/)"/></xsl:attribute><xsl:attribute name="id">MustContainFrontCoverImage</xsl:attribute><xsl:attribute name="name">MustContainFrontCoverImage</xsl:attribute><xsl:apply-templates/></svrl:active-pattern><xsl:apply-templates select="/" mode="M5"/><svrl:active-pattern><xsl:attribute name="document"><xsl:value-of select="document-uri(/)"/></xsl:attribute><xsl:attribute name="id">MustContainTwoReleases</xsl:attribute><xsl:attribute name="name">MustContainTwoReleases</xsl:attribute><xsl:apply-templates/></svrl:active-pattern><xsl:apply-templates select="/" mode="M6"/><svrl:active-pattern><xsl:attribute name="document"><xsl:value-of select="document-uri(/)"/></xsl:attribute><xsl:attribute name="id">MustContainOneSingleRelease</xsl:attribute><xsl:attribute name="name">MustContainOneSingleRelease</xsl:attribute><xsl:apply-templates/></svrl:active-pattern><xsl:apply-templates select="/" mode="M7"/><svrl:active-pattern><xsl:attribute name="document"><xsl:value-of select="document-uri(/)"/></xsl:attribute><xsl:attribute name="id">MustContainOneTrackRelease</xsl:attribute><xsl:attribute name="name">MustContainOneTrackRelease</xsl:attribute><xsl:apply-templates/></svrl:active-pattern><xsl:apply-templates select="/" mode="M8"/><svrl:active-pattern><xsl:attribute name="document"><xsl:value-of select="document-uri(/)"/></xsl:attribute><xsl:attribute name="id">MustContainOneSoundRecordingResourceGroup</xsl:attribute><xsl:attribute name="name">MustContainOneSoundRecordingResourceGroup</xsl:attribute><xsl:apply-templates/></svrl:active-pattern><xsl:apply-templates select="/" mode="M9"/><svrl:active-pattern><xsl:attribute name="document"><xsl:value-of select="document-uri(/)"/></xsl:attribute><xsl:attribute name="id">MustContainOneImageResourceGroup</xsl:attribute><xsl:attribute name="name">MustContainOneImageResourceGroup</xsl:attribute><xsl:apply-templates/></svrl:active-pattern><xsl:apply-templates select="/" mode="M10"/><svrl:active-pattern><xsl:attribute name="document"><xsl:value-of select="document-uri(/)"/></xsl:attribute><xsl:attribute name="id">MustContainSequencedTrackBundle</xsl:attribute><xsl:attribute name="name">MustContainSequencedTrackBundle</xsl:attribute><xsl:apply-templates/></svrl:active-pattern><xsl:apply-templates select="/" mode="M11"/><svrl:active-pattern><xsl:attribute name="document"><xsl:value-of select="document-uri(/)"/></xsl:attribute><xsl:attribute name="id">SecondaryResourcesMustNotBeSequenced</xsl:attribute><xsl:attribute name="name">SecondaryResourcesMustNotBeSequenced</xsl:attribute><xsl:apply-templates/></svrl:active-pattern><xsl:apply-templates select="/" mode="M12"/><svrl:active-pattern><xsl:attribute name="document"><xsl:value-of select="document-uri(/)"/></xsl:attribute><xsl:attribute name="id">PrimaryResourcesShouldBeSequencedWithinTheirBundleResourceGroup</xsl:attribute><xsl:attribute name="name">PrimaryResourcesShouldBeSequencedWithinTheirBundleResourceGroup</xsl:attribute><xsl:apply-templates/></svrl:active-pattern><xsl:apply-templates select="/" mode="M13"/><svrl:active-pattern><xsl:attribute name="document"><xsl:value-of select="document-uri(/)"/></xsl:attribute><xsl:attribute name="id">SoundRecordingMustHaveReferenceTitle</xsl:attribute><xsl:attribute name="name">SoundRecordingMustHaveReferenceTitle</xsl:attribute><xsl:apply-templates/></svrl:active-pattern><xsl:apply-templates select="/" mode="M14"/><svrl:active-pattern><xsl:attribute name="document"><xsl:value-of select="document-uri(/)"/></xsl:attribute><xsl:attribute name="id">SingleFormalTitlePerTerritory</xsl:attribute><xsl:attribute name="name">SingleFormalTitlePerTerritory</xsl:attribute><xsl:apply-templates/></svrl:active-pattern><xsl:apply-templates select="/" mode="M15"/><svrl:active-pattern><xsl:attribute name="document"><xsl:value-of select="document-uri(/)"/></xsl:attribute><xsl:attribute name="id">SingleDisplayTitlePerTerritory</xsl:attribute><xsl:attribute name="name">SingleDisplayTitlePerTerritory</xsl:attribute><xsl:apply-templates/></svrl:active-pattern><xsl:apply-templates select="/" mode="M16"/><svrl:active-pattern><xsl:attribute name="document"><xsl:value-of select="document-uri(/)"/></xsl:attribute><xsl:attribute name="id">AtLeastOneDisplayArtist</xsl:attribute><xsl:attribute name="name">AtLeastOneDisplayArtist</xsl:attribute><xsl:apply-templates/></svrl:active-pattern><xsl:apply-templates select="/" mode="M17"/><svrl:active-pattern><xsl:attribute name="document"><xsl:value-of select="document-uri(/)"/></xsl:attribute><xsl:attribute name="id">ParentalWarningMustBeSet</xsl:attribute><xsl:attribute name="name">ParentalWarningMustBeSet</xsl:attribute><xsl:apply-templates/></svrl:active-pattern><xsl:apply-templates select="/" mode="M18"/><svrl:active-pattern><xsl:attribute name="document"><xsl:value-of select="document-uri(/)"/></xsl:attribute><xsl:attribute name="id">PLineMustBeProvided</xsl:attribute><xsl:attribute name="name">PLineMustBeProvided</xsl:attribute><xsl:apply-templates/></svrl:active-pattern><xsl:apply-templates select="/" mode="M19"/><svrl:active-pattern><xsl:attribute name="document"><xsl:value-of select="document-uri(/)"/></xsl:attribute><xsl:attribute name="id">IssuingLabelMustBeProvided</xsl:attribute><xsl:attribute name="name">IssuingLabelMustBeProvided</xsl:attribute><xsl:apply-templates/></svrl:active-pattern><xsl:apply-templates select="/" mode="M20"/><svrl:active-pattern><xsl:attribute name="document"><xsl:value-of select="document-uri(/)"/></xsl:attribute><xsl:attribute name="id">AtLeastOneGenre</xsl:attribute><xsl:attribute name="name">AtLeastOneGenre</xsl:attribute><xsl:apply-templates/></svrl:active-pattern><xsl:apply-templates select="/" mode="M21"/><svrl:active-pattern><xsl:attribute name="document"><xsl:value-of select="document-uri(/)"/></xsl:attribute><xsl:attribute name="id">HasGridOrIcpn</xsl:attribute><xsl:attribute name="name">HasGridOrIcpn</xsl:attribute><xsl:apply-templates/></svrl:active-pattern><xsl:apply-templates select="/" mode="M22"/><svrl:active-pattern><xsl:attribute name="document"><xsl:value-of select="document-uri(/)"/></xsl:attribute><xsl:attribute name="id">PrimaryResourcesIdentifiedByISRC</xsl:attribute><xsl:attribute name="name">PrimaryResourcesIdentifiedByISRC</xsl:attribute><xsl:apply-templates/></svrl:active-pattern><xsl:apply-templates select="/" mode="M23"/><svrl:active-pattern><xsl:attribute name="document"><xsl:value-of select="document-uri(/)"/></xsl:attribute><xsl:attribute name="id">SecondaryResourcesIdentifiedByProprietaryId</xsl:attribute><xsl:attribute name="name">SecondaryResourcesIdentifiedByProprietaryId</xsl:attribute><xsl:apply-templates/></svrl:active-pattern><xsl:apply-templates select="/" mode="M24"/><svrl:active-pattern><xsl:attribute name="document"><xsl:value-of select="document-uri(/)"/></xsl:attribute><xsl:attribute name="id">MustContainOneComponentRelease</xsl:attribute><xsl:attribute name="name">MustContainOneComponentRelease</xsl:attribute><xsl:apply-templates/></svrl:active-pattern><xsl:apply-templates select="/" mode="M25"/></svrl:schematron-output></xsl:template>

<!--SCHEMATRON PATTERNS-->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Audio Single</svrl:text>

<!--PATTERN MustContainOneSoundRecording-->
...
<xsl:template match="ernm:NewReleaseMessage/ResourceList" priority="1000" mode="M2"><svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="ernm:NewReleaseMessage/ResourceList"/>
		...
		<!--ASSERT -->
<xsl:choose><xsl:when test="count(SoundRecording) = 1"/><xsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="count(SoundRecording) = 1"><xsl:attribute name="location"><xsl:apply-templates select="." mode="schematron-select-full-path"/></xsl:attribute><svrl:text>
...
<!--PATTERN MustContainMusicalWorkSoundRecording-->
...
<xsl:template match="ernm:NewReleaseMessage/ResourceList" priority="1000" mode="M5"><svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="ernm:NewReleaseMessage/ResourceList"/>
		...
		<!--ASSERT -->
<xsl:choose><xsl:when test="Image/ImageType[text() = 'FrontCoverImage']"/><xsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="Image/ImageType[text() = 'FrontCoverImage']"><xsl:attribute name="location"><xsl:apply-templates select="." mode="schematron-select-full-path"/></xsl:attribute><svrl:text>
...
<xsl:template match="ernm:NewReleaseMessage/ReleaseList" priority="1000" mode="M7"><svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="ernm:NewReleaseMessage/ReleaseList"/>
		...
		<!--ASSERT -->
<xsl:choose><xsl:when test="Release/ReleaseType[text() = 'Single']"/><xsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="Release/ReleaseType[text() = 'Single']"><xsl:attribute name="location"><xsl:apply-templates select="." mode="schematron-select-full-path"/></xsl:attribute><svrl:text>
...
<xsl:template match="ernm:NewReleaseMessage/ReleaseList" priority="1000" mode="M8"><svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="ernm:NewReleaseMessage/ReleaseList"/>
		...
		<!--ASSERT -->
<xsl:choose><xsl:when test="Release/ReleaseType[text() = 'TrackRelease']"/><xsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="Release/ReleaseType[text() = 'TrackRelease']"><xsl:attribute name="location"><xsl:apply-templates select="." mode="schematron-select-full-path"/></xsl:attribute><svrl:text>
...
<!--PATTERN MustContainOneSoundRecordingResourceGroup-->


	<!--RULE -->
<xsl:template match="ernm:NewReleaseMessage/ReleaseList/Release[ReleaseType = 'Single'] | ernm:NewReleaseMessage/ReleaseList/Release[ReleaseType = 'Album']" priority="1000" mode="M9"><svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="ernm:NewReleaseMessage/ReleaseList/Release[ReleaseType = 'Single'] | ernm:NewReleaseMessage/ReleaseList/Release[ReleaseType = 'Album']"/>
...
<!--PATTERN MustContainOneImageResourceGroup-->


	<!--RULE -->
<xsl:template match="ernm:NewReleaseMessage/ReleaseList/Release[ReleaseType = 'Single'] | ernm:NewReleaseMessage/ReleaseList/Release[ReleaseType = 'Album']" priority="1000" mode="M10"><svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="ernm:NewReleaseMessage/ReleaseList/Release[ReleaseType = 'Single'] | ernm:NewReleaseMessage/ReleaseList/Release[ReleaseType = 'Album']"/>

		<!--ASSERT -->
<xsl:choose><xsl:when test="descendant::ResourceGroupContentItem[ResourceType = 'Image' and ReleaseResourceReference[@ReleaseResourceType = 'SecondaryResource']]"/><xsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="descendant::ResourceGroupContentItem[ResourceType = 'Image' and ReleaseResourceReference[@ReleaseResourceType = 'SecondaryResource']]"><xsl:attribute name="location"><xsl:apply-templates select="." mode="schematron-select-full-path"/></xsl:attribute><svrl:text>
...
<!--PATTERN SecondaryResourcesMustNotBeSequenced-->
	...
	<!--RULE -->
<xsl:template match="ResourceGroup/ResourceGroupContentItem[ReleaseResourceReference[@ReleaseResourceType = 'SecondaryResource']]" priority="1000" mode="M12"><svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="ResourceGroup/ResourceGroupContentItem[ReleaseResourceReference[@ReleaseResourceType = 'SecondaryResource']]"/>
...
<xsl:if test="SequenceNumber"><svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="SequenceNumber"><xsl:attribute name="location"><xsl:apply-templates select="." mode="schematron-select-full-path"/></xsl:attribute><svrl:text>
			...
			</svrl:text></svrl:successful-report></xsl:if><xsl:apply-templates select="*|comment()|processing-instruction()" mode="M12"/></xsl:template><xsl:template match="text()" priority="-1" mode="M12"/><xsl:template match="@*|node()" priority="-2" mode="M12"><xsl:apply-templates select="*|comment()|processing-instruction()" mode="M12"/></xsl:template>

<!--PATTERN PrimaryResourcesShouldBeSequencedWithinTheirBundleResourceGroup-->


	<!--RULE -->
<xsl:template match="ernm:NewReleaseMessage/ReleaseList/Release/ReleaseDetailsByTerritory/ResourceGroup/ResourceGroup" priority="1000" mode="M13"><svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="ernm:NewReleaseMessage/ReleaseList/Release/ReleaseDetailsByTerritory/ResourceGroup/ResourceGroup"/>
...
<!--PATTERN SoundRecordingMustHaveReferenceTitle-->
	...
	<!--RULE -->
<xsl:template match="ernm:NewReleaseMessage/ResourceList/SoundRecording" priority="1000" mode="M14"><svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="ernm:NewReleaseMessage/ResourceList/SoundRecording"/>

		<!--ASSERT -->
<xsl:choose><xsl:when test="count(ReferenceTitle[string-length(normalize-space(TitleText)) &gt; 0]) = 1"/><xsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="count(ReferenceTitle[string-length(normalize-space(TitleText)) &gt; 0]) = 1"><xsl:attribute name="location"><xsl:apply-templates select="." mode="schematron-select-full-path"/></xsl:attribute><svrl:text>
...
<!--PATTERN SingleFormalTitlePerTerritory-->
	...
	<!--RULE -->
<xsl:template match="ernm:NewReleaseMessage/ReleaseList/Release/ReleaseDetailsByTerritory[1]" priority="1000" mode="M15"><svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="ernm:NewReleaseMessage/ReleaseList/Release/ReleaseDetailsByTerritory[1]"/>

		<!--ASSERT -->
<xsl:choose><xsl:when test="Title[@TitleType='FormalTitle'][string-length(normalize-space(TitleText)) &gt; 0]"/><xsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="Title[@TitleType='FormalTitle'][string-length(normalize-space(TitleText)) &gt; 0]"><xsl:attribute name="location"><xsl:apply-templates select="." mode="schematron-select-full-path"/></xsl:attribute><svrl:text>
...
<!--PATTERN SingleDisplayTitlePerTerritory-->
	...
	<!--RULE -->
<xsl:template match="ernm:NewReleaseMessage/ReleaseList/Release/ReleaseDetailsByTerritory[1]" priority="1000" mode="M16"><svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="ernm:NewReleaseMessage/ReleaseList/Release/ReleaseDetailsByTerritory[1]"/>

		<!--ASSERT -->
<xsl:choose><xsl:when test="Title[@TitleType='DisplayTitle'][string-length(normalize-space(TitleText)) &gt; 0]"/><xsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="Title[@TitleType='DisplayTitle'][string-length(normalize-space(TitleText)) &gt; 0]"><xsl:attribute name="location"><xsl:apply-templates select="." mode="schematron-select-full-path"/></xsl:attribute><svrl:text>
...
<!--PATTERN AtLeastOneDisplayArtist-->
	...
	<!--RULE -->
<xsl:template match="ernm:NewReleaseMessage/ReleaseList/Release" priority="1000" mode="M17"><svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="ernm:NewReleaseMessage/ReleaseList/Release"/>
...
<!--PATTERN ParentalWarningMustBeSet-->
	...
	<!--RULE -->
<xsl:template match="ernm:NewReleaseMessage" priority="1000" mode="M18"><svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="ernm:NewReleaseMessage"/>
...
<!--PATTERN PLineMustBeProvided-->
	...
	<!--RULE -->
<xsl:template match="ernm:NewReleaseMessage/ReleaseList/Release" priority="1000" mode="M19"><svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="ernm:NewReleaseMessage/ReleaseList/Release"/>
...
<!--PATTERN HasGridOrIcpn-->
	...
	<!--RULE -->
<xsl:template match="ernm:NewReleaseMessage/ReleaseList/Release[ReleaseType != 'TrackRelease' and ReleaseType != 'VideoTrackRelease']" priority="1000" mode="M22"><svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="ernm:NewReleaseMessage/ReleaseList/Release[ReleaseType != 'TrackRelease' and ReleaseType != 'VideoTrackRelease']"/>
...
<!--PATTERN SecondaryResourcesIdentifiedByProprietaryId-->
	...
	<!--RULE -->
<xsl:template match="//ResourceGroupContentItem/ReleaseResourceReference[@ReleaseResourceType = 'SecondaryResource']" priority="1000" mode="M24"><svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="//ResourceGroupContentItem/ReleaseResourceReference[@ReleaseResourceType = 'SecondaryResource']"/>
...
<!--PATTERN MustContainOneComponentRelease-->


	<!--RULE -->
<xsl:template match="ernm:NewReleaseMessage/ReleaseList/Release[1]/descendant::ResourceGroupContentItem[ReleaseResourceReference[@ReleaseResourceType = 'PrimaryResource']]" priority="1000" mode="M25"><svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="ernm:NewReleaseMessage/ReleaseList/Release[1]/descendant::ResourceGroupContentItem[ReleaseResourceReference[@ReleaseResourceType = 'PrimaryResource']]"/>

		<!--ASSERT -->
<xsl:choose><xsl:when test="//Release[ReleaseType[(text() = 'TrackRelease') or (text() = 'VideoTrackRelease')]]/ReleaseResourceReferenceList/ReleaseResourceReference = ./ReleaseResourceReference"/><xsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="//Release[ReleaseType[(text() = 'TrackRelease') or (text() = 'VideoTrackRelease')]]/ReleaseResourceReferenceList/ReleaseResourceReference = ./ReleaseResourceReference"><xsl:attribute name="location"><xsl:apply-templates select="." mode="schematron-select-full-path"/></xsl:attribute><svrl:text> 
