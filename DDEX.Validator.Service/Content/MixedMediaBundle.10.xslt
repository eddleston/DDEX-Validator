...
<!--SCHEMA SETUP-->
<xsl:template match="/"><svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="Mixed Media Bundle" schemaVersion=""><xsl:comment><xsl:value-of select="$archiveDirParameter"/>   
		 <xsl:value-of select="$archiveNameParameter"/>  
		 <xsl:value-of select="$fileNameParameter"/>  
		 <xsl:value-of select="$fileDirParameter"/></xsl:comment><svrl:ns-prefix-in-attribute-values uri="http://ddex.net/xml/ern/34" prefix="ernm"/><svrl:active-pattern><xsl:attribute name="document"><xsl:value-of select="document-uri(/)"/></xsl:attribute><xsl:attribute name="id">MustContainTwoDifferentResourceTypes</xsl:attribute><xsl:attribute name="name">MustContainTwoDifferentResourceTypes</xsl:attribute><xsl:apply-templates/></svrl:active-pattern><xsl:apply-templates select="/" mode="M2"/><svrl:active-pattern><xsl:attribute name="document"><xsl:value-of select="document-uri(/)"/></xsl:attribute><xsl:attribute name="id">MustContainOneImage</xsl:attribute><xsl:attribute name="name">MustContainOneImage</xsl:attribute><xsl:apply-templates/></svrl:active-pattern><xsl:apply-templates select="/" mode="M3"/><svrl:active-pattern><xsl:attribute name="document"><xsl:value-of select="document-uri(/)"/></xsl:attribute><xsl:attribute name="id">MustContainFrontCoverImage</xsl:attribute><xsl:attribute name="name">MustContainFrontCoverImage</xsl:attribute><xsl:apply-templates/></svrl:active-pattern><xsl:apply-templates select="/" mode="M4"/><svrl:active-pattern><xsl:attribute name="document"><xsl:value-of select="document-uri(/)"/></xsl:attribute><xsl:attribute name="id">MustContainABundle</xsl:attribute><xsl:attribute name="name">MustContainABundle</xsl:attribute><xsl:apply-templates/></svrl:active-pattern><xsl:apply-templates select="/" mode="M5"/><svrl:active-pattern><xsl:attribute name="document"><xsl:value-of select="document-uri(/)"/></xsl:attribute><xsl:attribute name="id">MustContainAComponentRelease</xsl:attribute><xsl:attribute name="name">MustContainAComponentRelease</xsl:attribute><xsl:apply-templates/></svrl:active-pattern><xsl:apply-templates select="/" mode="M6"/><svrl:active-pattern><xsl:attribute name="document"><xsl:value-of select="document-uri(/)"/></xsl:attribute><xsl:attribute name="id">MustContainOneVideoResourceGroup</xsl:attribute><xsl:attribute name="name">MustContainOneVideoResourceGroup</xsl:attribute><xsl:apply-templates/></svrl:active-pattern><xsl:apply-templates select="/" mode="M7"/><svrl:active-pattern><xsl:attribute name="document"><xsl:value-of select="document-uri(/)"/></xsl:attribute><xsl:attribute name="id">MustContainOneImageResourceGroup</xsl:attribute><xsl:attribute name="name">MustContainOneImageResourceGroup</xsl:attribute><xsl:apply-templates/></svrl:active-pattern><xsl:apply-templates select="/" mode="M8"/><svrl:active-pattern><xsl:attribute name="document"><xsl:value-of select="document-uri(/)"/></xsl:attribute><xsl:attribute name="id">MustContainSequencedTrackBundle</xsl:attribute><xsl:attribute name="name">MustContainSequencedTrackBundle</xsl:attribute><xsl:apply-templates/></svrl:active-pattern><xsl:apply-templates select="/" mode="M9"/><svrl:active-pattern><xsl:attribute name="document"><xsl:value-of select="document-uri(/)"/></xsl:attribute><xsl:attribute name="id">SecondaryResourcesMustNotBeSequenced</xsl:attribute><xsl:attribute name="name">SecondaryResourcesMustNotBeSequenced</xsl:attribute><xsl:apply-templates/></svrl:active-pattern><xsl:apply-templates select="/" mode="M10"/><svrl:active-pattern><xsl:attribute name="document"><xsl:value-of select="document-uri(/)"/></xsl:attribute><xsl:attribute name="id">PrimaryResourcesShouldBeSequencedWithinTheirBundleResourceGroup</xsl:attribute><xsl:attribute name="name">PrimaryResourcesShouldBeSequencedWithinTheirBundleResourceGroup</xsl:attribute><xsl:apply-templates/></svrl:active-pattern><xsl:apply-templates select="/" mode="M11"/><svrl:active-pattern><xsl:attribute name="document"><xsl:value-of select="document-uri(/)"/></xsl:attribute><xsl:attribute name="id">SoundRecordingMustHaveReferenceTitle</xsl:attribute><xsl:attribute name="name">SoundRecordingMustHaveReferenceTitle</xsl:attribute><xsl:apply-templates/></svrl:active-pattern><xsl:apply-templates select="/" mode="M12"/><svrl:active-pattern><xsl:attribute name="document"><xsl:value-of select="document-uri(/)"/></xsl:attribute><xsl:attribute name="id">SingleFormalTitlePerTerritory</xsl:attribute><xsl:attribute name="name">SingleFormalTitlePerTerritory</xsl:attribute><xsl:apply-templates/></svrl:active-pattern><xsl:apply-templates select="/" mode="M13"/><svrl:active-pattern><xsl:attribute name="document"><xsl:value-of select="document-uri(/)"/></xsl:attribute><xsl:attribute name="id">SingleDisplayTitlePerTerritory</xsl:attribute><xsl:attribute name="name">SingleDisplayTitlePerTerritory</xsl:attribute><xsl:apply-templates/></svrl:active-pattern><xsl:apply-templates select="/" mode="M14"/><svrl:active-pattern><xsl:attribute name="document"><xsl:value-of select="document-uri(/)"/></xsl:attribute><xsl:attribute name="id">AtLeastOneDisplayArtist</xsl:attribute><xsl:attribute name="name">AtLeastOneDisplayArtist</xsl:attribute><xsl:apply-templates/></svrl:active-pattern><xsl:apply-templates select="/" mode="M15"/><svrl:active-pattern><xsl:attribute name="document"><xsl:value-of select="document-uri(/)"/></xsl:attribute><xsl:attribute name="id">ParentalWarningMustBeSet</xsl:attribute><xsl:attribute name="name">ParentalWarningMustBeSet</xsl:attribute><xsl:apply-templates/></svrl:active-pattern><xsl:apply-templates select="/" mode="M16"/><svrl:active-pattern><xsl:attribute name="document"><xsl:value-of select="document-uri(/)"/></xsl:attribute><xsl:attribute name="id">PLineMustBeProvided</xsl:attribute><xsl:attribute name="name">PLineMustBeProvided</xsl:attribute><xsl:apply-templates/></svrl:active-pattern><xsl:apply-templates select="/" mode="M17"/><svrl:active-pattern><xsl:attribute name="document"><xsl:value-of select="document-uri(/)"/></xsl:attribute><xsl:attribute name="id">IssuingLabelMustBeProvided</xsl:attribute><xsl:attribute name="name">IssuingLabelMustBeProvided</xsl:attribute><xsl:apply-templates/></svrl:active-pattern><xsl:apply-templates select="/" mode="M18"/><svrl:active-pattern><xsl:attribute name="document"><xsl:value-of select="document-uri(/)"/></xsl:attribute><xsl:attribute name="id">AtLeastOneGenre</xsl:attribute><xsl:attribute name="name">AtLeastOneGenre</xsl:attribute><xsl:apply-templates/></svrl:active-pattern><xsl:apply-templates select="/" mode="M19"/><svrl:active-pattern><xsl:attribute name="document"><xsl:value-of select="document-uri(/)"/></xsl:attribute><xsl:attribute name="id">HasGridOrIcpn</xsl:attribute><xsl:attribute name="name">HasGridOrIcpn</xsl:attribute><xsl:apply-templates/></svrl:active-pattern><xsl:apply-templates select="/" mode="M20"/><svrl:active-pattern><xsl:attribute name="document"><xsl:value-of select="document-uri(/)"/></xsl:attribute><xsl:attribute name="id">PrimaryResourcesIdentifiedByISRC</xsl:attribute><xsl:attribute name="name">PrimaryResourcesIdentifiedByISRC</xsl:attribute><xsl:apply-templates/></svrl:active-pattern><xsl:apply-templates select="/" mode="M21"/><svrl:active-pattern><xsl:attribute name="document"><xsl:value-of select="document-uri(/)"/></xsl:attribute><xsl:attribute name="id">SecondaryResourcesIdentifiedByProprietaryId</xsl:attribute><xsl:attribute name="name">SecondaryResourcesIdentifiedByProprietaryId</xsl:attribute><xsl:apply-templates/></svrl:active-pattern><xsl:apply-templates select="/" mode="M22"/></svrl:schematron-output></xsl:template>

<!--SCHEMATRON PATTERNS-->
<svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Mixed Media Bundle</svrl:text>

<!--PATTERN MustContainTwoDifferentResourceTypes-->


	<!--RULE -->
<xsl:template match="ernm:NewReleaseMessage" priority="1000" mode="M2"><svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="ernm:NewReleaseMessage"/>

		<!--ASSERT -->
<xsl:choose><xsl:when test="count(distinct-values(//ResourceGroupContentItem[ReleaseResourceReference[@ReleaseResourceType='PrimaryResource']]/ResourceType)) &gt; 1"/><xsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="count(distinct-values(//ResourceGroupContentItem[ReleaseResourceReference[@ReleaseResourceType='PrimaryResource']]/ResourceType)) &gt; 1"><xsl:attribute name="location"><xsl:apply-templates select="." mode="schematron-select-full-path"/></xsl:attribute><svrl:text>
...
<xsl:template match="ernm:NewReleaseMessage/ResourceList" priority="1000" mode="M3"><svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="ernm:NewReleaseMessage/ResourceList"/>
		...
		<!--ASSERT -->
<xsl:choose><xsl:when test="Image"/><xsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="Image"><xsl:attribute name="location"><xsl:apply-templates select="." mode="schematron-select-full-path"/></xsl:attribute><svrl:text>
...
<!--PATTERN MustContainABundle-->


	<!--RULE -->
<xsl:template match="ernm:NewReleaseMessage/ReleaseList" priority="1000" mode="M5"><svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="ernm:NewReleaseMessage/ReleaseList"/>

		<!--ASSERT -->
<xsl:choose><xsl:when test="Release/ReleaseType[text() = 'Bundle']"/><xsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="Release/ReleaseType[text() = 'Bundle']"><xsl:attribute name="location"><xsl:apply-templates select="." mode="schematron-select-full-path"/></xsl:attribute><svrl:text>
...
<xsl:template match="ernm:NewReleaseMessage/ReleaseList" priority="1000" mode="M6"><svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="ernm:NewReleaseMessage/ReleaseList"/>
		...
		<!--ASSERT -->
<xsl:choose><xsl:when test="Release/ReleaseType[text() = 'TrackRelease'] | Release/ReleaseType[text() = 'VideoTrackRelease']"/><xsl:otherwise><svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="Release/ReleaseType[text() = 'TrackRelease'] | Release/ReleaseType[text() = 'VideoTrackRelease']"><xsl:attribute name="location"><xsl:apply-templates select="." mode="schematron-select-full-path"/></xsl:attribute><svrl:text>
...
<!--PATTERN MustContainOneVideoResourceGroup-->
	...
	<!--RULE -->
<xsl:template match="ernm:NewReleaseMessage/ReleaseList/Release" priority="1000" mode="M7"><svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="ernm:NewReleaseMessage/ReleaseList/Release"/>
...
<!--PATTERN MustContainOneImageResourceGroup-->
	...
	<!--RULE -->
<xsl:template match="ernm:NewReleaseMessage/ReleaseList/Release[ReleaseType = 'Bundle']" priority="1000" mode="M8"><svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="ernm:NewReleaseMessage/ReleaseList/Release[ReleaseType = 'Bundle']"/>
...
<!--PATTERN SecondaryResourcesMustNotBeSequenced-->
	...
	<!--RULE -->
<xsl:template match="ResourceGroup/ResourceGroupContentItem[ReleaseResourceReference[@ReleaseResourceType = 'SecondaryResource']]" priority="1000" mode="M10"><svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="ResourceGroup/ResourceGroupContentItem[ReleaseResourceReference[@ReleaseResourceType = 'SecondaryResource']]"/>
...
<xsl:if test="SequenceNumber"><svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="SequenceNumber"><xsl:attribute name="location"><xsl:apply-templates select="." mode="schematron-select-full-path"/></xsl:attribute><svrl:text>
			...
			</svrl:text></svrl:successful-report></xsl:if><xsl:apply-templates select="*|comment()|processing-instruction()" mode="M10"/></xsl:template><xsl:template match="text()" priority="-1" mode="M10"/><xsl:template match="@*|node()" priority="-2" mode="M10"><xsl:apply-templates select="*|comment()|processing-instruction()" mode="M10"/></xsl:template>

<!--PATTERN PrimaryResourcesShouldBeSequencedWithinTheirBundleResourceGroup-->


	<!--RULE -->
<xsl:template match="ernm:NewReleaseMessage/ReleaseList/Release[ReleaseType='Bundle']/ReleaseDetailsByTerritory/ResourceGroup/ResourceGroup" priority="1000" mode="M11"><svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="ernm:NewReleaseMessage/ReleaseList/Release[ReleaseType='Bundle']/ReleaseDetailsByTerritory/ResourceGroup/ResourceGroup"/>
...
<!--PATTERN SoundRecordingMustHaveReferenceTitle-->
	...
	<!--RULE -->
<xsl:template match="ernm:NewReleaseMessage/ResourceList/Video | ernm:NewReleaseMessage/ResourceList/SoundRecording" priority="1000" mode="M12"><svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="ernm:NewReleaseMessage/ResourceList/Video | ernm:NewReleaseMessage/ResourceList/SoundRecording"/>
...
<!--PATTERN SingleFormalTitlePerTerritory-->
	...
	<!--RULE -->
<xsl:template match="ernm:NewReleaseMessage/ReleaseList/Release/ReleaseDetailsByTerritory" priority="1000" mode="M13"><svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="ernm:NewReleaseMessage/ReleaseList/Release/ReleaseDetailsByTerritory"/>
...
<!--PATTERN ParentalWarningMustBeSet-->
	...
	<!--RULE -->
<xsl:template match="ernm:NewReleaseMessage" priority="1000" mode="M16"><svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="ernm:NewReleaseMessage"/>
...
<!--PATTERN HasGridOrIcpn-->
	...
	<!--RULE -->
<xsl:template match="ernm:NewReleaseMessage/ReleaseList/Release[ReleaseType != 'TrackRelease' and ReleaseType != 'VideoTrackRelease']" priority="1000" mode="M20"><svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="ernm:NewReleaseMessage/ReleaseList/Release[ReleaseType != 'TrackRelease' and ReleaseType != 'VideoTrackRelease']"/>
...
<!--PATTERN PrimaryResourcesIdentifiedByISRC-->
	...
	<!--RULE -->
<xsl:template match="//ResourceGroupContentItem/ReleaseResourceReference[@ReleaseResourceType = 'PrimaryResource']" priority="1000" mode="M21"><svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="//ResourceGroupContentItem/ReleaseResourceReference[@ReleaseResourceType = 'PrimaryResource']"/>
...
<!--PATTERN SecondaryResourcesIdentifiedByProprietaryId-->
	...
	<!--RULE -->
<xsl:template match="//ResourceGroupContentItem/ReleaseResourceReference[@ReleaseResourceType = 'SecondaryResource']" priority="1000" mode="M22"><svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="//ResourceGroupContentItem/ReleaseResourceReference[@ReleaseResourceType = 'SecondaryResource']"/>
